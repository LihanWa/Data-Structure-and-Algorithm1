 ...
 */
public interface LookupInterface<I, C> extends Iterable <I> {
    ...
    /**
     * Returns an iterator over the identifiers in this lookup, in an arbitrary
     * order.
     *
     * <p> The iterators returned by this method are *fail-fast*: if the lookup
     * is modified at any time after the iterator is created, the iterator will
     * throw a ConcurrentModificationException. Thus, in the face of concurrent
     * modification, the iterator fails quickly and cleanly, rather than risking
     * arbitrary, non-deterministic behavior at an undetermined time in the
     * future.
     *
     * <p> Iterators returned by this method should not support the .remove()
     * method, and should throw UnsupportedOperationException if it is called.
     *
     * @return an iterator over the identifiers in this list, in an arbitrary
     * order
     */
